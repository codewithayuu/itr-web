        ...
        >
          ...
          <h4 className="md:text-xl text-base font-medium text-gray-400 mt-1 mb-[-6px] italic flex ">
            <Image
              ...
              className="mr-2"
            />
            Information Technology - R Section
          </h4>

          <TextGenerateEffect
            words="Your one-stop destination for all class-related information. Find updates, timetable, faculty details, student directory, and photo gallery. Stay connected with your classmates and never miss important announcements."
          />
